...
/**
 * Created by sunny on 18-8-23.
 * 童话效果滤镜
 */

public class FairyTaleFilter extends GPUImageFilter {
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                mLookupSourceTexture = OpenGlUtils.loadTexture(InShowParams.context,"filter/fairy_tale.png");
            }
        });
    }
