...
import com.idx.inshowapp.baidu.recog.listener.IRecogListener;
import com.idx.inshowapp.baidu.recog.listener.RecogEventAdapter;
...
public class RecognizerManager {
     ...
     */
    public RecognizerManager(Context context, IRecogListener recogListener) {
