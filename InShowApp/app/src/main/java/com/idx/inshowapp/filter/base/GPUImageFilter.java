...
package com.idx.inshowapp.filter.base;
...
public class GPUImageFilter {
    ...
    protected void onInit() {
        ...
        mGLStrengthLocation = GLES20.glGetUniformLocation(mGLProgId,
                "strength");
        setFilterLevel(InShowParams.beautyLevel);
    }

    private void setFilterLevel(int beautyLevel) {
        setInteger(mGLStrengthLocation,beautyLevel);
    }

    public void onFilterLevelChange(){
        setFilterLevel(InShowParams.beautyLevel);
    }
    ...
    public int drawToTexture(final int textureId) {
        if(mFrameBuffers == null)
